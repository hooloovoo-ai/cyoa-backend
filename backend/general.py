...
DESCRIBE_PROMPT = "Below is a PASSAGE from a novel. Write a SHORT, CONDENSED DESCRIPTION OF AN ILLUSTRATION of the PASSAGE that would be suitable as a prompt to an image generation model such as Stable Diffusion or Midjourney.\n\nPASSAGE:\n{excerpt}\n\nSHORT, CONDENSED DESCRIPTION OF AN ILLUSTRATION:\n"
